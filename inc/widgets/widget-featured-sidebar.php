<?php
/**
 * Widget 1: Featured News with Sidebar
 *
...
class Tahseen_Ashrafi_Featured_Sidebar_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'tahseen_ashrafi_featured_sidebar_widget',
            __('Tahseen Ashrafi - Featured News with Sidebar', 'tahseen-ashrafi'),
            array(
                'description' => __('Widget 1: Left column (58%) large featured post + Right column (42%) vertical list of smaller posts with thin dividers.', 'tahseen-ashrafi')
            )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if ($post_query->have_posts()) {
            ...
            ?>
            <div class="widget-featured-sidebar-container">
                <!-- Left Column (58%) -->
                    ...
                    ?>
                        <div class="featured-main-card">
                            ...
                            <div class="featured-main-body">
                                ...
                                <?php endif; ?>
                                <h3 class="featured-main-headline">
                        ...
                        ?>
                            <div class="vertical-post-item">
                                <?php if (has_post_thumbnail($sub_post->ID)) : ?>
                                    <div class="vertical-post-thumb">
                                        <a href="<?php echo esc_url(get_permalink($sub_post->ID)); ?>">
                                            <?php echo get_the_post_thumbnail($sub_post->ID, 'thumbnail'); ?>
                                        </a>
                                    </div>
                                <?php endif; ?>
                                <div class="vertical-post-content">
                                    <?php if ($cat_name) : ?>
                                        <span class="category-badge"><?php echo esc_html($cat_name); ?></span>
                                    <?php endif; ?>
                                    <h4 class="vertical-post-headline">
