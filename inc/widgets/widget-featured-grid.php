...
class Tahseen_Ashrafi_Featured_Grid_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'tahseen_ashrafi_featured_grid_widget',
            __('Tahseen Ashrafi - Featured Grid', 'tahseen-ashrafi'),
            array(
                'description' => __('Widget 4: Left side large featured post + Right side 2x2 or 2x3 grid of smaller posts.', 'tahseen-ashrafi')
            )
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if ($post_query->have_posts()) {
            ...
            <div class="featured-grid-layout-container">
                ...
                <!-- Right Side Grid (2x2 or 2x3) -->
                <div class="featured-grid-right">
                    <div class="sub-post-grid-2col">
